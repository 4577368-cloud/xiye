...
export const extendedToolsData: AITool[] = [
  ...
  // ==================== 全球顶级LLM ====================
  {
    ...
    type: 'ai-product',
    url: 'https://manus.im',
    description: '通用型AI Agent，能自主完成文件处理、数据分析、代码编写等复杂任务',
  ...
  },
  {
    ...
    description: '字节跳动推出的AI应用开发平台，无需编程基础即可创建AI Bot',
    tags: ['AI', 'Agent', '低代码', 'Bot', '字节跳动'],
    icon: 'fa-robot',
    featured: true,
  },
  {
    ...
    type: 'ai-product',
    url: 'https://dify.ai',
    description: '开源LLM应用开发平台，支持工作流编排、RAG和Agent能力',
    tags: ['AI', 'Agent', 'LLM', '工作流', 'RAG'],
  ...
  // ==================== 全球顶级LLM ====================
  {
    ...
    description: 'OpenAI推出的顶级对话式AI，支持多模态、插件生态和GPTs',
    tags: ['AI对话', 'LLM', 'OpenAI', 'GPT'],
    icon: 'fa-brain',
    featured: true,
  },
  {
    ...
    type: 'ai-product',
    url: 'https://claude.ai',
    description: 'Anthropic开发的AI助手，以安全性和长文本理解能力著称',
    tags: ['AI对话', 'LLM', 'Anthropic', '长文本'],
    icon: 'fa-brain',
    featured: true,
  },
  {
    ...
    type: 'ai-product',
    url: 'https://x.ai',
    description: 'xAI（马斯克团队）推出的AI聊天机器人，实时信息获取能力强',
    tags: ['AI对话', 'LLM', 'xAI', '马斯克'],
    icon: 'fa-rocket',
  },
  {
    id: 'new-7',
    ...
    description: '法国开源LLM团队，提供Mixtral等高性能模型',
    tags: ['AI对话', 'LLM', '开源', 'Mixtral'],
    icon: 'fa-fire',
  },
  // ==================== 国产大模型 ====================
  {
    ...
    description: '深度求索开发的通用大语言模型，编程和数学能力突出',
    tags: ['AI对话', 'LLM', '编程', '国产'],
    icon: 'fa-water',
    featured: true,
  },
  {
    ...
    description: '月之暗面推出的AI助手，支持200万字超长上下文',
    tags: ['AI对话', 'LLM', '长文本', '国产'],
    icon: 'fa-moon',
    featured: true,
  },
  {
    ...
    description: '字节跳动推出的AI助手，支持文本、图像生成和语音交互',
    tags: ['AI对话', 'LLM', '字节跳动', '多模态'],
    icon: 'fa-robot',
  },
  {
    id: 'new-11',
    ...
    description: '智谱AI推出的对话助手，支持代码、写作等多场景应用',
    tags: ['AI对话', 'LLM', '国产', '多场景'],
    icon: 'fa-language',
  },
  {
    id: 'new-12',
    ...
    description: '阿里达摩院打造的大模型产品，支持中英双语和代码生成',
    tags: ['AI对话', 'LLM', '阿里', '代码'],
    icon: 'fa-globe',
    featured: true,
  },
  {
    ...
    description: '百度推出的文心大模型，融合搜索和知识图谱能力',
    tags: ['AI对话', 'LLM', '百度', '搜索'],
    icon: 'fa-search',
  },
  {
    ...
    description: '科大讯飞推出的认知大模型，支持语音交互和多行业应用',
    tags: ['AI对话', 'LLM', '科大讯飞', '语音'],
    icon: 'fa-microphone',
  },
  // ==================== AI搜索 ====================
  {
    ...
    description: 'AI驱动的智能搜索引擎，实时联网、标注来源',
    tags: ['AI搜索', '搜索引擎', '实时'],
    icon: 'fa-searchengin',
    featured: true,
  },
  {
    ...
    type: 'ai-product',
    url: 'https://metaso.cn',
    description: '中文语义搜索，主攻学术资料和深度分析',
    tags: ['AI搜索', '中文', '学术'],
    icon: 'fa-book',
  },
  {
    ...
    description: '昆仑万维推出的AI搜索助手，支持对话和内容生成',
    tags: ['AI搜索', '对话', '国产'],
    icon: 'fa-search',
  },
  {
    ...
    description: '科研文献AI搜索，从2亿篇论文中提取结论',
    tags: ['AI搜索', '学术', '论文'],
  ...
  // ==================== AI图像生成 ====================
  {
    ...
    description: '公认最强的AI绘画工具，画风细腻，支持Discord操作',
    tags: ['AI绘画', '图像生成', 'Midjourney'],
    icon: 'fa-palette',
    featured: true,
  },
  {
    ...
    description: 'Stability AI开源的图像生成模型，支持本地部署',
    tags: ['AI绘画', '开源', 'Stable Diffusion', '本地'],
    icon: 'fa-stability',
  },
  {
    id: 'new-21',
    ...
    type: 'ai-product',
    url: 'https://flux.ai',
    description: 'Black Forest Labs推出的新一代图像生成模型，画质惊人',
    tags: ['AI绘画', '图像生成', 'Flux'],
    icon: 'fa-bolt',
  },
  {
    ...
    description: 'AI图像生成工具，特别擅长文字渲染和LOGO设计',
    tags: ['AI绘画', 'LOGO', '文字渲染'],
    icon: 'fa-image',
  },
  {
    ...
    description: '字节跳动推出的AI图像和视频生成工具',
    tags: ['AI绘画', '字节跳动', '图像生成'],
  ...
  },
  {
    ...
    description: '国内领先的AI图像创作平台，模型丰富社区活跃',
    tags: ['AI绘画', '模型社区', '国产'],
    icon: 'fa-images',
  },
  {
    ...
    description: '百度推出的AI绘画工具，擅长国风和水墨风格',
    tags: ['AI绘画', '百度', '国风'],
    icon: 'fa-brush',
  },
  {
    ...
    description: 'Adobe推出的创意AI工具集，深度集成Photoshop',
    tags: ['AI绘画', 'Adobe', '设计'],
    icon: 'fa-fire',
  },
  // ==================== AI视频生成 ====================
  {
    ...
    description: '快手推出的AI视频生成工具，支持长视频和高动态效果',
    tags: ['AI视频', '视频生成', '快手'],
    icon: 'fa-video',
    featured: true,
  },
  {
    ...
    description: '字节跳动推出的AI视频生成工具，画质优秀',
    tags: ['AI视频', '字节跳动', '视频生成'],
    icon: 'fa-video',
  },
  {
    ...
    description: '专业AI视频创作平台，支持Gen-3等最新技术',
    tags: ['AI视频', '视频编辑', '专业'],
    icon: 'fa-film',
  },
  {
    ...
    type: 'ai-product',
    url: 'https://pika.art',
    description: 'AI视频生成工具，操作简单，效果惊艳',
    tags: ['AI视频', '视频生成', '简单易用'],
  ...
  },
  {
    ...
    description: 'AI视频和3D重建工具，支持Dream Machine视频生成',
    tags: ['AI视频', '3D', '视频生成'],
    icon: 'fa-cube',
  },
  {
    ...
    description: 'AI视频生成工具，支持多种风格和特效',
    tags: ['AI视频', '视频生成', '特效'],
    icon: 'fa-wand-magic-sparkles',
  },
  // ==================== AI音乐/音频 ====================
  {
    ...
    type: 'ai-product',
    url: 'https://suno.ai',
    description: 'AI音乐生成工具，输入歌词和风格即可生成完整歌曲',
    tags: ['AI音乐', '歌曲生成', '音频'],
    icon: 'fa-music',
    featured: true,
  },
  {
    ...
    type: 'ai-product',
    url: 'https://udio.com',
    description: 'AI音乐生成平台，支持多种音乐风格创作',
    tags: ['AI音乐', '歌曲生成', '音频'],
    icon: 'fa-headphones',
  },
  {
    ...
    description: 'AI语音合成和克隆工具，支持28种语言',
    tags: ['AI语音', '语音合成', '克隆'],
  ...
  // ==================== AI编程 ====================
  {
    ...
    description: 'AI代码编辑器，基于VS Code，深度集成GPT-4',
    tags: ['AI编程', 'IDE', '代码生成'],
    icon: 'fa-code',
    featured: true,
  },
  {
    ...
    description: '字节跳动推出的AI编程工具，集成Claude和GPT模型',
    tags: ['AI编程', 'IDE', '字节跳动'],
    icon: 'fa-code',
    featured: true,
  },
  {
    ...
    description: 'GitHub和OpenAI推出的AI编程助手，代码补全神器',
    tags: ['AI编程', '代码补全', 'GitHub'],
    icon: 'fa-github',
  },
  // ==================== AI PPT ====================
  {
  ...
  },
  {
    ...
    description: '国产AI PPT工具，支持一键生成和在线编辑',
    tags: ['AI PPT', '演示文稿', '国产'],
  ...
  },
  {
    ...
    description: '智能PPT设计工具，自动美化幻灯片布局',
    tags: ['AI PPT', '演示文稿', '设计'],
    icon: 'fa-presentation',
  },
  // ==================== AI思维导图 ====================
  {
    ...
    type: 'ai-product',
    url: 'https://shutu.cn',
    description: 'AI思维导图工具，支持多种图形和团队协作',
    tags: ['AI思维导图', '思维导图', '协作'],
    icon: 'fa-sitemap',
  },
  // ==================== 数字人 ====================
  {
    ...
    description: 'AI数字人视频生成平台，快速创建虚拟主播',
    tags: ['数字人', 'AI视频', '虚拟主播'],
    icon: 'fa-user',
  },
  {
    ...
    description: 'AI数字人创作平台，支持照片说话和视频生成',
    tags: ['数字人', 'AI视频', '照片动画'],
  ...
  // ==================== 垂直场景 AI ====================
  {
    ...
    description: '自主执行任务的AI Agent，可自主规划和完成复杂目标',
    tags: ['AI', 'Agent', '自动化', '自主'],
    icon: 'fa-robot',
  },
  {
    id: 'new-48',
    ...
    description: 'Cognition AI推出的AI软件工程师，能独立完成整个开发任务',
    tags: ['AI编程', '软件工程', 'AI'],
    icon: 'fa-code',
  },
  {
    ...
    type: 'ai-product',
    url: 'https://x.ai',
    description: 'xAI（马斯克团队）推出的AI助手，实时信息获取能力强',
    tags: ['AI对话', 'LLM', 'xAI', '马斯克'],
    icon: 'fa-bolt',
    featured: true,
  },
